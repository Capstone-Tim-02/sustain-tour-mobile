...
class PointHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: pointHistoryProvider.listPointHistory.isNotEmpty
          ? Consumer<DestiPointProvider>(
